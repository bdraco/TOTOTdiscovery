...
class TOTOTDiscovery(asyncio.DatagramProtocol):
    ...
    def error_received(self, ex):
        """Handle error."""
        _LOGGER.error("TOTOTDiscovery error: %s", ex)

    def connection_lost(self, ex):
        pass


class AIOTOTOTScanner:
    """A TOTOT discovery scanner."""
